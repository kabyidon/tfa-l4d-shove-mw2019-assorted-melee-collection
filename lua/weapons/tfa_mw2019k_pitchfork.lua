...
SWEP.Purpose = "Efficent at grouping and pitching loads of material at a time. Stab forward for maximum affection."
SWEP.Slot = 0
...
SWEP.Primary.Attacks = {
	{
		...
		["src"] = Vector(0, 2.5, 70), -- Trace source; X ( +right, -left ), Y ( +forward, -back ), Z ( +up, -down )
		["dir"] = Vector(0, 15, -70), -- Trace direction/length; X ( +right, -left ), Y ( +forward, -back ), Z ( +up, -down )
...
SWEP.Secondary.Attacks = {
		...
		["len"] = 120, -- Trace distance
		["src"] = Vector(0, 2.5, 0), -- Trace source; X ( +right, -left ), Y ( +forward, -back ), Z ( +up, -down )
		["dir"] = Vector(0, 70, 15), -- Trace direction/length; X ( +right, -left ), Y ( +forward, -back ), Z ( +up, -down )
		["dmg"] = SWEP.Primary.Damage, --Damage
		["dmgtype"] = SWEP.Primary.DamageType,
		["delay"] = 10 / 30, --Delay
		["spr"] = true, --Allow attack while sprinting?
