...
SWEP.Purpose = "Famously known Samurai's Katana. Traditionally forged using a folded steel technique. Light to wield, resilient to force, and durable to wear."
SWEP.Slot = 0
...
SWEP.Primary.Attacks = {
	{
		...
		["src"] = Vector(80, 0, 80), -- Trace source; X ( +right, -left ), Y ( +forward, -back ), Z ( +up, -down )
		["dir"] = Vector(-80, 1, -80), -- Trace direction/length; X ( +right, -left ), Y ( +forward, -back ), Z ( +up, -down )
