...
SWEP.Purpose = "Military style tri-fold entrenching shovel. Typically used to dig a defensive fighting position, but is equally as effective as an ancillary weapon in close quarters combat."
SWEP.Slot = 0
...
SWEP.Secondary.BashLength         = 40 -- Length of bash melee trace in units
