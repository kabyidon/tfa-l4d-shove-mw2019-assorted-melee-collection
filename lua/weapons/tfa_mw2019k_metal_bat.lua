...
SWEP.Purpose = "Lethal sporting equipment. Lightweight bat with a metal structure. Swing for the fences to knock your enemies out of the park."
SWEP.Slot = 0
...
SWEP.Primary.Attacks = {
	{
		...
		["src"] = Vector(-75, 0, -18), -- Trace source; X ( +right, -left ), Y ( +forward, -back ), Z ( +up, -down )
		["dir"] = Vector(75, 5, 18), -- Trace direction/length; X ( +right, -left ), Y ( +forward, -back ), Z ( +up, -down )
	...
	},
	{
		...
		["len"] = 50, -- Trace distance
		["src"] = Vector(-75, 0, -18), -- Trace source; X ( +right, -left ), Y ( +forward, -back ), Z ( +up, -down )
		["dir"] = Vector(75, 1, 0), -- Trace direction/length; X ( +right, -left ), Y ( +forward, -back ), Z ( +up, -down )
		["dmg"] = SWEP.Primary.Damage, --Damage
		["dmgtype"] = SWEP.Primary.DamageType,
		["delay"] = 12 / 30, --Delay
		["spr"] = true, --Allow attack while sprinting?
...
SWEP.Secondary.Attacks = {
	{
		...
		["len"] = 50, -- Trace distance
		["src"] = Vector(0, 0, 80), -- Trace source; X ( +right, -left ), Y ( +forward, -back ), Z ( +up, -down )
		["dir"] = Vector(0, 1, -80), -- Trace direction/length; X ( +right, -left ), Y ( +forward, -back ), Z ( +up, -down )
