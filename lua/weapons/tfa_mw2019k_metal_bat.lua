...
SWEP.Primary.Attacks = {
	{
		...
		["src"] = Vector(-45, 0, -18), -- Trace source; X ( +right, -left ), Y ( +forward, -back ), Z ( +up, -down )
		["dir"] = Vector(45, 5, 18), -- Trace direction/length; X ( +right, -left ), Y ( +forward, -back ), Z ( +up, -down )
...
SWEP.Secondary.Attacks = {
	{
		...
		["len"] = 75, -- Trace distance
		["src"] = Vector(0, 0, 35), -- Trace source; X ( +right, -left ), Y ( +forward, -back ), Z ( +up, -down )
