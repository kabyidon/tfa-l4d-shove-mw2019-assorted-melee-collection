...
SWEP.Purpose = "Sharp cutting edge tool mainly utilized in busting debris and obstacles. Using your full body to carry momentum with each swing delivers fatal slices and digs."
SWEP.Slot = 0
...
SWEP.Primary.Attacks = {
	{
		...
		["src"] = Vector(0, 0, 100), -- Trace source; X ( +right, -left ), Y ( +forward, -back ), Z ( +up, -down )
		["dir"] = Vector(0, 1, -100), -- Trace direction/length; X ( +right, -left ), Y ( +forward, -back ), Z ( +up, -down )
	...
	},
	{
		...
		["len"] = 80, -- Trace distance
		["src"] = Vector(0, 0, 100), -- Trace source; X ( +right, -left ), Y ( +forward, -back ), Z ( +up, -down )
		["dir"] = Vector(-10, 1, -100), -- Trace direction/length; X ( +right, -left ), Y ( +forward, -back ), Z ( +up, -down )
		["dmg"] = SWEP.Primary.Damage, --Damage
		["dmgtype"] = SWEP.Primary.DamageType,
		["delay"] = 9 / 30, --Delay
		["spr"] = true, --Allow attack while sprinting?
...
SWEP.Secondary.Attacks = {
	{
		...
		["len"] = 80, -- Trace distance
		["src"] = Vector(200, 0, 0), -- Trace source; X ( +right, -left ), Y ( +forward, -back ), Z ( +up, -down )
		["dir"] = Vector(-200, 1, 0), -- Trace direction/length; X ( +right, -left ), Y ( +forward, -back ), Z ( +up, -down )
...
SWEP.Secondary.BashLength         = 80 -- Length of bash melee trace in units
